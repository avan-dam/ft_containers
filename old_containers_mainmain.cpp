...
/*                                                                            */
/*                                                        ::::::::            */
/*   old_containers_mainmain.cpp                        :+:    :+:            */
/*                                                     +:+                    */
/*   By: avan-dam <avan-dam@student.codam.nl>         +#+                     */
/*                                                   +#+                      */
/*   Created: 2021/03/23 14:38:34 by avan-dam      #+#    #+#                 */
/*   Updated: 2021/09/10 11:52:11 by ambervandam   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
bool	same_vecor_ft_std_int(std::vector<T> std, ft::vector<T> ft, std::string name_std, std::string name_ft)
{
	...
	while (c_it_std != std.end() && c_it_ft != ft.end())
	{
 	...
 	typename std::vector<T>::const_reverse_iterator c_it_r_stdr = std.rend();
 	typename ft::vector<T>::const_reverse_iterator c_it_r_ft = ft.rbegin();
 	typename ft::vector<T>::const_reverse_iterator c_it_r_ftr = ft.rend();
	while (c_it_r_std != c_it_r_stdr && c_it_r_ft != c_it_r_ftr)
	{
