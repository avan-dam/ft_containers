...
/*   Updated: 2021/08/10 13:51:55 by ambervandam   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
class tree_node
{
    public:
        ...
        tree_node(node_ptr parent) : first(), second(), _left(nullptr), _right(nullptr), _parent(parent), _end_node(true) {}
        ...
        bool        is_end_node()  {   return (_end_node);}
