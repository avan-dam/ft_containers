...
class tree_node
{
    public:
        ...
        tree_node(node_ptr parent) : _data(), _left(NULL), _right(NULL), _parent(parent), _end_node(false), _start_node(false) {}
        tree_node(T data, node_ptr parent) : _data(data), _left(NULL), _right(NULL), _parent(parent), _end_node(false), _start_node(false) {}
